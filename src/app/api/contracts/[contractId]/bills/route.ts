 ...
 * the recurring monthly charges (RENTAL/UTILITIES/AC/DRYER). LATE_FEE is excluded here —
 * those are only ever auto-generated by the cron job, never hand-created. */
const BILL_TYPES = [
  "DEPOSIT",
  "UTILITIES",
  "RENTAL",
